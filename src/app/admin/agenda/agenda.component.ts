    ...
    <app-layout 
      ...
      (logout)="logout()">
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Agenda da Doula</h2>
            <p class="text-gray-600">Esta página irá exibir o calendário completo com todos os compromissos. Funcionalidade em desenvolvimento.</p>
            <div class="mt-4 h-96 bg-gray-100 rounded-md flex items-center justify-center">
                <span class="text-gray-400">Componente de Calendário Interativo</span>
            </div>
        </div>
    </app-layout>
  `,
